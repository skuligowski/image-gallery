...
export const fetchUser = createAsyncThunk('api/user', async ({ refLocation }: FetchUserData, { rejectWithValue }) => {
...
export const loginUser = createAsyncThunk('api/login', async ({ username, password }: LoginData) => {
